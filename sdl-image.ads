...
package SDL.image is
  ...
  function Load (file: cs.chars_ptr) return SDL.video.surface_access_t;
  pragma import (c, Load, "IMG_Load");

  function LoadTyped_RW
   (src     : SDL.rwops.rwops_access_t;
    free    : c.int;
    typestr : cs.chars_ptr) return SDL.video.surface_access_t;

  function load_typed_RW
   (src     : SDL.rwops.rwops_access_t;
    free    : c.int;
    typestr : cs.chars_ptr) return SDL.video.surface_access_t renames LoadTyped_RW;
  pragma import (c, LoadTyped_RW, "IMG_LoadTyped_RW");

  function Load_RW
   (src  : SDL.rwops.rwops_access_t;
    free : c.int) return SDL.video.surface_access_t;
  pragma import (c, Load_RW, "IMG_Load_RW");

  function Load (file : string) return SDL.video.surface_access_t;
  function LoadTyped_RW
   (src     : SDL.rwops.rwops_access_t;
    free    : boolean;
  ...
  function load_typed_rw
   (src     : SDL.rwops.rwops_access_t;
    free    : boolean;
    typestr : string) return SDL.video.surface_access_t renames LoadTyped_RW;

  function Load_RW
   (src  : SDL.rwops.rwops_access_t;
    free : boolean) return SDL.video.surface_access_t;
